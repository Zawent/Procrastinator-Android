...
public interface RegisterAPIService {
    @FormUrlEncoded
    @POST("auth/signup")
    Call<RespuestaLogin> registrar (@Field("name")String name, @Field("edad")int edad, @Field("ocupacion")String ocupacion, @Field("email")String email, @Field("password")String password, @Field("id_rol")int id_rol);
